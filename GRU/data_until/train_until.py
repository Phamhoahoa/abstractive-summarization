...
def get_input_from_batch(batch, use_cuda):
    ...
    context_t_1 = Variable(torch.zeros((batch_size, config.hidden_dim)))
    coverage = None
    ...
    return enc_batch, enc_padding_mask, enc_lens, enc_batch_extend_vocab, extra_zeros, context_t_1, coverage
